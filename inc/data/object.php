...
class BaseObject
	...
	public		$key ; // Valeurs de la cl� primaire
	public		$state ; // Etat de l'objet
	protected	$mainobject ; // Objet principal auquel l'objet est rattach�

	// Constructeur
	// $appctx: contexte d'application.
	// $factory:
	// $key tableau associatif contenant les valeurs de la cl�e primaire, si null alors nouvel objet � inserer dans la DB
	...
	// D�finie le mainobjet
	public function setMainObject( $object )
	{
		$this->mainobject = $object ;
	}

	// Retourne ce qui doit etre fait � la prochaine sauvegarde
	...
	// Demande � la factory de cr�er une copie
	...
	// Met a jour les champs: attribut + case du tableau values inexistant � partir du tableau associatif
	...
	// Renvoie les donn�es de l'objet
	...
	// Cree la chaine de caract�re pour l'envoie de l'entete
	...
	// Cree la chaine de caract�re pour l'envoie des valeurs du tableau values 
