/*********************************************************
* Classe FmSite: Formulaire de mise a jour
* d'une adresse de structure
*********************************************************/

function FmSite( modele )
	{
	herite( FmSite, Formulaire ) ;
	this.initFmSite( modele ) ;
	}

FmSite.prototype =
	{
	initFmSite: function( modele )
		{
		this.initFormulaire( "Formulaire de mise a jour d'un site" ) ;
		
		this.addField( new FfInput( "site", 40 ) ) ;
