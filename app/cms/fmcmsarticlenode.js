/*********************************************************
* Classe FmCmsArticleNode: Formulaire d'appel 
* de module du CMS a partir d'un article
*********************************************************/

function FmCmsArticleNode( formulairecontroler, modele )
	{
	herite( FmCmsArticleNode, Formulaire ) ;
	this.initFmCmsArticleNode( formulairecontroler, modele ) ;
	}

FmCmsArticleNode.prototype =
	{
	initFmCmsArticleNode: function( modele )
		{
		...
		this.addField( new FfInput( "reference", 80 ) ) ;		
	...
	onLayout: function()
		...
		var ha = this.layout.add( new HTabLayout() ) ;
		ha.add( new FfEtiquette( "Nom de l'argument donnant la reference de l'article:" ) ) ;
